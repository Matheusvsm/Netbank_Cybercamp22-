CREATE FUNCTION public.getprofileactionfunctionbyprofileidandactionfunctionid(
...
WHERE
		...
		"ActionFunctionId" = "paramActionFunctionId" AND
		"DeletionDate" IS NULL
$BODY$;
ALTER FUNCTION public.getprofileactionfunctionbyprofileidandactionfunctionid(bigint, bigint)
    OWNER TO "OSB";